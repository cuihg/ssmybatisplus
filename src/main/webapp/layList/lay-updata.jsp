...
<script>
    layui.use(['table', 'form', 'layer', 'laydate'], function () {
      ...
      var serach= window.location.search;
        $.ajax({
            type: 'post',
            url: '${pageContext.request.contextPath }/selectbyid.do'+serach,
            datatype: 'json',
            success:function (data) {
                //alert(data.ename)
                form.val("emp", { //formTest 即 class="layui-form" 所在元素属性 lay-filter="" 对应的值
...
//常规用法
        ...
        form.on('submit(demo1)', function (data) {
            ...
            $.ajax({
                ...
                url: 'http://localhost:8080/save.do',
